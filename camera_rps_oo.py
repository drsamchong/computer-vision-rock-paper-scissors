...
class Rock_Paper_Scissors():
    ...
    #            print(prediction)
        ...
        if user_choice == "Nothing":
            ...
            user_choice = self.capture_user_choice()
    ...
    def get_user_choice(self):
        return self.capture_user_choice()
    ...
    def play(self):
        winning_rounds = ceil(self.n_rounds / 2)
        rounds_played = 0
        computer_wins = 0
        user_wins = 0
        while rounds_played < self.n_rounds: # and user_wins < 3 and computer_wins < 3:
